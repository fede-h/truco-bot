...
# -- Scenario 1 --
@given("a new hand where Mano wins the second trick after a parda in the first trick", target_fixture="trick_results")
...
# -- Scenario 2 --
@given("a player is dealt a hand with 10 of Copas, 11 of Copas, and 2 of Bastos", target_fixture="envido_hand")
def given_figure_hand():
    return [
        create_card(10, Suit.COPAS),
        create_card(11, Suit.COPAS),
        create_card(2, Suit.BASTOS)
    ]
