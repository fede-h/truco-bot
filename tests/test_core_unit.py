# ponytail: simple unit tests for core game logic
...
def test_envido_calculation():
    ...
    cards4 = [create_card(12, Suit.ESPADAS), create_card(11, Suit.BASTOS), create_card(10, Suit.OROS)]
...
def test_state_play_3_tricks():
    # Set up rigged hands
    hands = [
        [create_card(1, Suit.ESPADAS), create_card(7, Suit.ESPADAS), create_card(3, Suit.ESPADAS)], # P0: ranks 14, 12, 10
        [create_card(4, Suit.COPAS), create_card(5, Suit.COPAS), create_card(6, Suit.COPAS)] # P1: ranks 1, 2, 3
    ]
